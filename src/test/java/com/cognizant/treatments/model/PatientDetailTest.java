...
public class PatientDetailTest {
	...
	public void test_PatientDetail_LongStringIntStringStringString() {
		PatientDetail patientData = new PatientDetail(101, "Harry", 24, "Urology", "Package 1", "21/06/2022");
	...
	public void test_SetTreatmentCommencementDate() {
		patientDetail.setTreatmentCommencementDate("21/06/2022");
		assertEquals("21/06/2022",patientDetail.getTreatmentCommencementDate());
	}
