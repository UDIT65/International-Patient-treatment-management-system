...
public class TreatmentPlanTest {
	...
	public void test_SetTreatmentCommencementDate() {
		treatmentPlan.setTreatmentCommencementDate("21/06/2022");
		assertEquals("21/06/2022", treatmentPlan.getTreatmentCommencementDate());
	}
	...
	public void test_SetTreatmentEndDate() {
		treatmentPlan.setTreatmentEndDate("21/07/2022");
		assertEquals("21/07/2022", treatmentPlan.getTreatmentEndDate());
	}
